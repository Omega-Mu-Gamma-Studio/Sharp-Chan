export const SHOP_ITEMS = [
  ...
  },
  {
    ...
    imageSrc: null,
    description: "Sharp-Chan's signature look. Always with you.",
    isDefault: true,
  },
  {
    id: 'outfit-gamedev',
...
export const DOWNLOADABLE_WALLPAPERS = [
  {
    ...
    accent: '#b46eff',
    imageSrc: '/wallpapers/sharpchan-compile-time.png',
    fileName: 'sharpchan-compile-time.png',
  ...
  },
  {
    ...
    accent: '#7c6fff',
    imageSrc: '/wallpapers/sharpchan-the-stack.png',
    fileName: 'sharpchan-the-stack.png',
  ...
  },
  {
    ...
    accent: '#b46eff',
    imageSrc: '/wallpapers/sharpchan-rainy.png',
    fileName: 'sharpchan-rainy-commute.png',
  ...
  },
  {
    ...
    accent: '#ffcc6e',
    imageSrc: '/wallpapers/sharpchan-vacation-build.png',
    fileName: 'sharpchan-vacation-build.png',
...

  {
    ...
    accent: '#ffb7d5',
    imageSrc: '/wallpapers/sharpchan-sakura.png',
    fileName: 'sharpchan-cherry-blossom.png',
    description: 'Petals falling. A C# reference open on her lap. A perfect afternoon.',
    requiredLevel: 3,
    comingSoon: false,
  },

 {
    ...
    accent: '#ffcc6e',
    imageSrc: '/wallpapers/sharpchan-mountain-summit.png',
    fileName: 'sharpchan-mountain-summit.png',
    description: 'She made it to the top. The flag says static void Main(). So did you.',
    requiredLevel: 5,
    comingSoon: false,
  },
    ...
    accent: '#ffaa55',
    imageSrc: '/wallpapers/sharpchan-autumn-library.png',
    fileName: 'sharpchan-autumn-library.png',
 ...
 
  {
    ...
    accent: '#7fff9b',
    imageSrc: '/wallpapers/sharpchan-rooftop-garden.png',
    fileName: 'sharpchan-rooftop-garden.png',
  ...
  },
  {
    ...
    accent: '#ff69b4',
    imageSrc: '/wallpapers/sharpchan-neon-arcade.png',
    fileName: 'sharpchan-neon-arcade.png',
  ...
  },
  {
    ...
    accent: '#ffccaa',
    imageSrc: '/wallpapers/sharpchan-shrine-steps.png',
    fileName: 'sharpchan-shrine-steps.png',
